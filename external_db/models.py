...
class CategoriesSites(ExternalBase):
...
class Collections(ExternalBase):
...
class GenresSites(ExternalBase):
...
class SimilarTitles(ExternalBase):
...
class SimilarTitlesVotes(ExternalBase):
...
class TitlePromotion(ExternalBase):
...
class TitleStatistics(ExternalBase):
...
class TitleStatus(ExternalBase):
...
class TitleStatusSites(ExternalBase):
...
class TitleTypeSites(ExternalBase):
...
class TitlesCategories(ExternalBase):
...
class TitlesCollections(ExternalBase):
...
class TitlesSites(ExternalBase):
...
class TitleChapter(ExternalBase):
...
class UserTitleData(ExternalBase):
...
class TitlesTitleRelation(ExternalBase):
